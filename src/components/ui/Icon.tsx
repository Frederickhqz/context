...
const icons: Record<string, React.ReactNode> = {
  ...
  graph: (
    <>
      ...
      <path strokeLinecap="round" d="M14.5 10.5L17 8M9.5 10.5L7 8M9.5 13.5L7 16M14.5 13.5L17 16" />
    </>
  ),
  tree: (
    <>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v6m0 0l-3-3m3 3l3-3M12 9v6m-3 3l3-3 3 3M6 21h12" />
    </>
  ),
  // Status
  check: (
